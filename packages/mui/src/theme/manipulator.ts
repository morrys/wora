 ...
 */
function clamp(value, min = 0, max = 1): any {
    /* warning(
        value >= min && value <= max,
 ...
 */
export function getContrastRatio(foreground: string, background: string): any {
 ...
 */
export function getLuminance(color: string): any {
 ...
 */
export function emphasize(color: string, coefficient: number = 0.15): any {
 ...
 * @returns {string} A CSS color string. Hex input values are returned as rgb
 */
export function fade(color: any, value: number): any {
 ...
 * @returns {string} A CSS color string. Hex input values are returned as rgb
 */
export function darken(color: any, coefficient: number): any {
 ...
 * @returns {string} A CSS color string. Hex input values are returned as rgb
 */
export function lighten(color: any, coefficient: number): any {
